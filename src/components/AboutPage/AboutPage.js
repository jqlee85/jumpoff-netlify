    ...
    return <section className="about-page single-page">
      ...
      <div className="jo-row">
        <div className="jo-content jo-post-content-wrapper">
          ...
          <p>I have 8 years of experience designing and coding for the web, designing/coding custom PHP CMSes for Groupon, doing custom WordPress development and e-commerce sites for businesses while working at <a href="https://www.hawaiiwebgroup.com">an agency in Hawaii</a>, and developing premium WordPress themes and plugins for <a href="https://www.organicthemes.com/" target="_blank">Organic Themes</a>.</p>
          ...
          <p>I love new challenges and helping people achieve their goals on the web, so if you'd like to discuss your project, please drop me a line below or find me on <a href="https://www.linkedin.com/in/jesse-lee-495577139/">LinkedIn</a>.</p>
        </div>
      </div>
